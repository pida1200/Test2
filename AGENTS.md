...
| `docs/wiki/` | Seed GitHub Wiki — ploché unikátní stránky (`aplikacni-*.md`, `provozni-*.md`, `zmeny-*.md`) |
...
- `multi-agenti.mdc` — role 3+3 (analytik/vývojář/tester + kontroloři), I/O = GitHub Issues, jen na žádost; kickoff aliasy **`/m`** (plná pipeline) a **`/m 2`** (Vývojář + Kontrolor); detail `docs/multi-agent-workflow.md`, snippety `docs/prompt-snippets.md`
