...
Zdroj struktury v gitu (`docs/wiki/`). Stejnou hierarchii drž v **GitHub Wiki** repa.
...
- **Stav požadavku:** GitHub Issues (`[PIPELINE]` + child + `gate/*`)
- **Delší dokumentace / artefakty:** tato Wiki (seed)
